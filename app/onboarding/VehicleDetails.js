...
const VehicleDetails = () => {
  const vehicelImages = {
    bicke:
      "https://immediad.com/wp-content/uploads/2022/05/194-1945076_super-bike-png-bike-images-free-download-searchpng.png",
  };
  ...
  const [selectedVehichicle, setSelectedVehicleImage] = useState("");
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={[Style.justifyStart, Style.flex1]}>
          ...
          <Image
            ...
            source={selectedVehichicle ? { uri: selectedVehichicle } : moto}
          />
          <Spacing val={20} />
          <DriverCostDetails
