...
//   // console.log("notification PickupModal", newRideRequest);
...
//   //       console.log("Data saved successfully from driver pickup modal", msgData);
//   //     } catch (error) {
...
const DriverPickupModal = ({ visible, onClose, newRideRequest }) => {
  const [dropoffModalVisible, setDropoffModalVisible] = useState(false);
