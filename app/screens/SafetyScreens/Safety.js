...
//             {/* First section: 8 boxes in 4 rows, with a button below the first row */}
...
//             <Text style={styles.heading}>How you're protected</Text>

//             {/* Third section: 6 boxes in 3 rows, similar to the first section */}
//             <View style={styles.row}>
//                 <View style={styles.box}></View>
//                 <View style={styles.box}></View>
//             </View>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.row}>
                ...
                {/* <View style={styles.protectedBox}>
                    <Text style={styles.protectedBoxText}>24/7 emergency</Text>
                </View> */}
            </View>
            {/* <View style={styles.row}>
                <View style={styles.protectedBox}>
