...
const Profile = ({}) => {
  ...
  const profileOptions = [
    ...
    // },
    {
      ...
      title: "Documents",
      icon: (
        <MaterialIcons name="insert-drive-file" size={24} color="#808080" />
      ),
      screen: "Documents",
    },
    {
    ...
    // },
    {
      id: 10,
      title: "Logout",
      icon: <MaterialCommunityIcons name="logout" size={24} color="#844201" />,
      action: () => handleLogout(),
    },
    {
      id: 11,
    ...
    <View>
      ...
      >
        ...
        <View style={styles.textContainer}>
          <Text style={[Style.fontMedium, Style.colorGray1, Style.label]}>
            {item.title}
          </Text>
          {item.description && (
            <Text style={[Style.fontMedium, Style.label14, Style.colorGray]}>
              {item.description}
            </Text>
          )}
        </View>
  ...
  const ListHeader = () => {
    return (
      <>
        <Spacing val={Platform.OS === "ios" ? 35 : 15} />
        <View style={[Style.alignCenter, Style.justifyCenter]}>
          <Image
            source={
              user ? { uri: user?.photo } : require("../../assets/driver.png")
            }
            style={styles.image}
          />
        </View>
        ...
        <Rating
          ...
          ratingCount={5}
          imageSize={30}
          startingValue={user?.driver_rating || 0}
          readonly
          style={styles.rating}
        />
        <Spacing val={20} />
        ...
        <View
          style={[styles.ridesContainer, Style.flexRow, Style.selfAlignCenter]}
        >
          <View style={styles.completedContainer}>
            <FontAwesome name="check-circle" size={18} color="black" />
            <Text style={[Style.fontSemiBold, Style.label14, Style.colorBlack]}>
