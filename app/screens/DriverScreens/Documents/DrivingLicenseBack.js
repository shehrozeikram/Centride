    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <Text style={styles.title}>Driving License Back</Text>
                <Text style={styles.description}>
                    Back side of your driving license is required.
                </Text>
            </View>
            ...
            <TouchableOpacity
                ...
                {selectedImage ? (
                    ...
                    <Image
                        source={require('../../../assets/personal-doc-sample.png')}
