...
const DriveWithUs = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>{t("drive_with_us_description")}</Text>
      <Text style={styles.subTitle}>{t("why_drive_with_us")}</Text>
      <Text style={styles.bulletPoint}>{t("drive_with_us_bullet_1")}</Text>
      <Text style={styles.bulletPoint}>{t("drive_with_us_bullet_2")}</Text>
      <Text style={styles.bulletPoint}>{t("drive_with_us_bullet_3")}</Text>
      <Text style={styles.bulletPoint}>{t("drive_with_us_bullet_4")}</Text>
