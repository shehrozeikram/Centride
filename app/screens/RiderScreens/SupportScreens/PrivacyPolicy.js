...
const PrivacyPolicy = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>{t(privacyPolicyTextKey.intro)}</Text>
      ...
      <Text style={styles.description}>{t(privacyPolicyTextKey.changes)}</Text>

      {/* <Text style={styles.description}>{t(privacyPolicyTextKey.contact)}</Text> */}
