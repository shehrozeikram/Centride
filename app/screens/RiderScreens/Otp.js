...
function Otp() {
  ...
  const updatePushNotificationToken = async () => {
    try {
      ...
      console.log("Push notification token updated successfully:", response);
    } catch (error) {
  ...
  return (
    <View style={[Style.container, Style.hPaddingSixteen]}>
      ...
      <View>
        ...
        <OtpInput onCodeFilled={handleCodeFilled} length={6} colorBlack />
      </View>
      ...
      >
        <Text style={[Style.fontRegular, Style.subLabel, Style.colorBlack]}>
